...
(function initAgeQuickTipsPanel(global) {
    ...
    const QUICK_TIPS = [
        ...
        'Settlement Patrol (ranks 1–7) is the entry guild bout; Civilian Escort (town+, ranks 7–14) and Border Patrol (town+, rank 14+) are higher tiers.',
        'Trade Escort unlocks with the Merchant\'s Assistant skill and pays merchant claim cards redeemable for gold.',
